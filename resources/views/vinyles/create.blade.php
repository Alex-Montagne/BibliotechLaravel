@extends('layouts.app', [
    'title' => 'Créer un vinyle',
    'breadcrumbs' => [
        ['label' => 'Catalogue', 'url' => route('vinyles.index')],
        ['label' => 'Créer un vinyle', 'url' => null]
    ]
])
        ...
        <div class="col-12 col-lg-8 mx-auto">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h2 class="mb-0"><i class="fas fa-plus-circle"></i> Créer un nouveau vinyle</h2>
                </div>
                <div class="card-body">
                    <form action="{{ route('vinyles.store') }}" method="POST" class="needs-validation">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('nb_tours') is-invalid @enderror" 
                                       id="nb_tours" name="nb_tours" value="{{ old('nb_tours') }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('num_serie') is-invalid @enderror" 
                                   id="num_serie" name="num_serie" value="{{ old('num_serie') }}" 
                        ...
                        <div class="d-flex gap-2 justify-content-end">
                            ...
                            <button type="submit" class="btn btn-success">
                                <i class="fas fa-save"></i> Créer le vinyle
                            </button>
                        </div>
                    </form>
                </div>
